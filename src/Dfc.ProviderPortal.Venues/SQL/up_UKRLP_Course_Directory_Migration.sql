...
WITH CTE (PROVIDER_ID, VENUE_ID, VENUE_NAME, PROV_VENUE_ID, ADDRESS_1, ADDRESS_2, TOWN, COUNTY, POSTCODE)
AS (
	--exec up_VenueListForCsvExport
	SELECT PROVIDER_ID, VENUE_ID, VENUE_NAME, PROV_VENUE_ID, ADDRESS_1, ADDRESS_2, TOWN, COUNTY, POSTCODE
	FROM @venues
)
