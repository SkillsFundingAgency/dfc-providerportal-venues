...
//using Dfc.ProviderPortal.Venues.Annotations; //NCS.DSS.Customer.Annotations;
//using Dfc.ProviderPortal.Venues.Ioc; //NCS.DSS.Customer.Ioc;


//namespace Dfc.ProviderPortal.Venues.Definition
//{
//    public static class ApiDefinition
//    {
//        public const string APITitle = "Venues";
//        public const string APIDefinitionName = "API-Definition";
//        public const string APIDefRoute = APITitle + "/" + APIDefinitionName;
//        public const string APIDescription = "Basic details of a Course Directory " + APITitle + " resource";
